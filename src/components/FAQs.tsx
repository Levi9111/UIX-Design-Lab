...
const AccordionItem = ({
  ...
  return (
    <div
      className='rounded-lg border border-white/10 p-4 cursor-pointer bg-background/40'
      style={{
    ...
    <section className='md:mt-48 relative'>
      <div className='uix-center pb-[140px]'>
        ...
        <div className='mt-[60px] flex flex-col lg:flex-row items-start justify-center gap-8'>
          {/* Left: Support Card */}
          <div
            className='w-full max-w-[368px] min-h-[250px] bg-background/40 border border-white/10 p-6 rounded-3xl text-white 
          shadow-inner mt-6 md:mt-0 relative overflow-hidden'
          >
            {/* Angled top for visual separation */}
